<?php class Top25SocialBaba extends WP_Widget{

 function __construct() {
 
        parent::__construct(
            'top25-social-icons',  // Base ID
            'Top 25 Social Icons'   // Name
        );
 
        add_action( 'widgets_init', function() {
            register_widget( 'Top25SocialBaba' );
        });
   add_action( 'admin_print_styles', array( &$this, 'Top25Social_register_admin_styles' ) );
    }
...
<br/><img class="lt-images" src="<?php echo plugins_url( '/top-25-social-icons/images/icons-16/email.png')?>" alt="Email"><input class="icon-fields" id="<?php echo $this->get_field_id('text11'); ?>"  placeholder="<?php echo ucfirst( 'Email address' ); ?>" name="<?php echo  $this->get_field_name('text11');?>" type="text" value="<?php echo $text11; ?>" /><br/>
...
public function Top25Social_register_admin_styles() {
...
add_action( 'widgets_init', 'Top25Social_register_widgets' );
 
function Top25Social_register_widgets() {
    register_widget( 'Top25SocialBaba' );
}